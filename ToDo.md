...
2. Your root CLAUDE.md currently says this project has "only completed Phase 0" and "no code generated yet" — that's stale (Phases 0–4 and 6 are done, CLI exists with tests). Want me to fix that separately?

Build an Artifact with the UI design of this project.
